...
{
    public abstract class Sprite : Graphic
    {


        public static Missing missingSprite = new Missing();
        public static Stillframe entityMarker = new Stillframe("EntityMarker.png");
        ...
        public static byte CENTERED = 0;
        public static byte CENTERED_BOTTOM = 1;
        public static byte CENTERED_TOP = 2;
    ...
    public static class Stillframe extends Sprite
    {  // Object with still image
    ...
    public Stillframe(String path, int offset_x, int offset_y, byte flag)
    { //CONSTRUCTOR ALLOWING FOR CERTAIN AUTOMATIC INITIALIZERS LIKE CENTERING
        super(0, 0);
    ...
    public Stillframe(String path, int offset_x, int offset_y, byte flag, int sizePercent)
    { //CONSTRUCTOR ALLOWING FOR CERTAIN AUTOMATIC INITIALIZERS LIKE CENTERING
        super(0, 0);
        initialize(path, flag);
    ...
    public Stillframe(String path, byte flag)
    { //CONSTRUCTOR ALLOWING FOR CERTAIN AUTOMATIC INITIALIZERS LIKE CENTERING
        super(0, 0);
        initialize(path, flag);
    ...
    private void initialize(String path, byte...flag)
    {
        ...
        else
        {
            ...
            if (flag.length == 1)
            {
                if (!initFlags(wholeImage, flag[0]))
                { //apply offsetting flags
    ...
    public String getPathName()
    {
        ...
        public override void draw(ReferenceFrame camera, GraphicComposite.Static composite)
    {
